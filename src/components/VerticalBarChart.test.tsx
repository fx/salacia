...
describe('VerticalBarChart', () => {
  describe('Component Rendering', () => {
    it('should render with required props', () => {
      const { container } = render(
        <VerticalBarChart data={[10, 20, 30]} />
      );
  ...
  describe('Bar Rendering and Measurements', () => {
    it('should render bars within a square box', () => {
      const { container } = render(
        <VerticalBarChart data={[10, 20, 30]} height={10} />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle large datasets', () => {
      ...
      const { container } = render(
        <VerticalBarChart data={largeData} />
      );
    ...
    it('should handle custom height parameter', () => {
      const { container } = render(
        <VerticalBarChart data={[10, 20, 30]} height={20} />
      );
