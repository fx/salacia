...
describe('VerticalBarChart 24-Hour Zero Handling', () => {
  it('should render all 24 bars even when some values are 0', () => {
    ...
    const hourlyData = [
      ...
      1,
      3,
      5, // 00:00 - 07:00 (quiet night hours)
      10,
      15,
      20,
      25,
      ...
      2,
      1,
      0, // 16:00 - 23:00 (evening wind down)
    ];
  ...
  it('should handle all-zero data gracefully', () => {
    ...
    const { container } = render(
      <VerticalBarChart data={zeroData} xAxisLabels={hourLabels} height={10} />
    );
  ...
  it('should maintain bar visibility even after data updates', () => {
    const { container, rerender } = render(
      <VerticalBarChart data={[10, 20, 30]} xAxisLabels={['A', 'B', 'C']} height={10} />
    );
    ...
    rerender(<VerticalBarChart data={hourlyData} xAxisLabels={hourLabels} height={10} />);
  ...
  it('should properly scale mixed zero and non-zero values', () => {
    ...
    const { container } = render(<VerticalBarChart data={sparseData} height={10} />);
